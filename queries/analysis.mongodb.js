...
const moviesAfter2000YearQuery = db.movies.aggregate([
    {
        $match:
            {
                genres: {
...
console.table(moviesAfter2000YearQuery);


const avgRatingQuery = db.movies.aggregate(
    [
        {
            $lookup:
            /**
...
console.table(avgRatingQuery);




const directorViewsQuery = db.movies.aggregate([
    {
        $group:
        /**
         * _id: The id of the group.
...
console.table(directorViewsQuery);



const highestViewsQuery = db.movies.aggregate([
    {
        $sort:
        /**
...
console.table(highestViewsQuery);